(function () {
    $.mojuMsgBox2 = {
		...
		mojuAlertPic: function (title,msg1,msg2,pic,callback_ok,callback_edit,callback_del) {
		...
		*/
        ...
        mojuConfirm: function (title, msg, callback) {
		 ...
		 printerAlert: function (title, msg,printerlist, callback) {
            GenerateHtml04(title, msg,printerlist);
            btnOk(callback);
            btnNo();
        },
	...
	//生成Html,带img
    var GenerateHtml02 = function (title,msg1,msg2) {
        var _html = "";
		...
		_html +="<br>";
		_html += '<a>迁移到:</a><input id="mojuMoveInput"/>';
		_html += '<br><br>';
        _html += '<input id="mb_btn_ok" type="button" value="确定迁移" />';
		_html += '<input id="mb_btn_no" type="button" value="取消" />';
		_html += '<input id="mb_btn_edit" type="button" value="归位" />';
		_html += '<input id="mb_btn_del" type="button" value="模具" />';
        _html += '</div></div>';
	...
	//生成html,带确定和退出按钮
		...
		//生成html,打印列表
	    var GenerateHtml04 = function (title, msg,printerlist) {
        var _html = "";
        _html += '<div id="mb_box"></div><div id="mb_con"><span id="mb_tit">' + title + '</span>';
        _html += '<a id="mb_ico">x</a><div id="mb_msg">' + msg + '</div><div id="mb_btnbox">';
        _html += '<input id="mb_btn_ok" type="button" value="确定" />';
